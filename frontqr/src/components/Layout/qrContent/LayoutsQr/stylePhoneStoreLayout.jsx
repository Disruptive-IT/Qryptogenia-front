...
export const StoreLayout = ({ appFormValues }) => {
    ...
    return (
        <div style={{ background: backgroundcolor }} className="flex flex-col min-h-screen w-full items-center justify-center">
            <div
                style={{ background: backgroundcolor }}
                className="bg-gradient-to-b flex flex-col h-full items-center sm:min-w-[390px] sm:min-h-[665px] md:max-w-[430px] md:max-h-[700px] rounded-[55px] mx-auto "
            >
                ...
                <div
                    style={{ background: backgroundcolor }}
                    className="rounded-b-[55px] p-8 pb-20 flex flex-col items-center w-full h-full "
                >
                    <div className="w-full">
                        <p
                            style={{ color: textColor }}
                            className={`font-bold mb-6 mt-4 text-center ${title.length > 22 ? 'text-xl' : 'text-2xl'} whitespace-pre-line break-words`}>
                            {title}
                        </p>
                    </div>
