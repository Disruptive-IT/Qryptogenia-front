...
const qrStyles = [
    { id: 1, type: 'default', icon: TbLetterX , style: { borderColor: 'transparent' }, shape: 'none', backgroundType: 'none', backgroundType: 'pattern' },
    { id: 2, type: 'circle', icon: MdOutlineQrCode2, style: { borderRadius: '50%', borderColor: '#000000' }, shape: 'circle', backgroundType: 'pattern' },
    ...
    { id: 5, type: 'hexagon', icon: MdOutlineQrCode2, style: { clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 24%)', borderColor: '#000000 ' }, shape: 'hexagon', backgroundType: 'pattern',  },
    { id: 6, type: 'octagon', icon: MdOutlineQrCode2, style: { clipPath: 'polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)', borderColor: '#000000' }, shape: 'octagon', backgroundType: 'pattern',},
];
