...
var Board = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: prefixCls, ref: node },
        React__default['default'].createElement("div", { className: prefixCls + "-hsv", style: {
                backgroundColor: hueColor,
                height: colorBoardHeight + "px",
                minHeight: colorBoardHeight + "px"
            } },
            React__default['default'].createElement("div", { className: prefixCls + "-value" }),
            React__default['default'].createElement("div", { className: prefixCls + "-saturation" })),
        React__default['default'].createElement("span", { style: {
                left: "calc(" + xRel + "% - 7px)",
                top: "calc(" + yRel + "% - 7px)",
                backgroundColor: color.toHexString()
            } }),
        React__default['default'].createElement("div", { className: prefixCls + "-handler", onMouseDown: onBoardMouseDown, onTouchStart: onBoardTouchStart })));
};
...
var Ribbon = function (_a) {
    ...
    var hue = color.hue;
    var per = (hue / 360) * 100;
    return (React__default['default'].createElement("div", { className: prefixCls, ref: node, onMouseDown: onMouseDown, onTouchStart: onTouchStart },
        React__default['default'].createElement("div", { className: 'color-picker-panel-ribbon-bg' }),
        React__default['default'].createElement("span", { style: { left: per + "%", backgroundColor: hueColor } }),
        React__default['default'].createElement("div", { className: prefixCls + "-handler" })));
};
...
var Alpha = function (_a) {
    ...
    var prefixCls = getPrefixCls();
    return (React__default['default'].createElement("div", { className: prefixCls, ref: node, onMouseDown: onMouseDown, onTouchStart: onTouchStart },
        React__default['default'].createElement("div", { className: prefixCls + "-bg", style: { background: getBackground() } }),
        React__default['default'].createElement("span", { style: {
                left: alpha + "%",
...
var Panel = function (_a) {
    ...
    var _c = __read(React.useState(false), 2), change = _c[0], setChange = _c[1];
    React.useEffect(function () {
        if (!change) {
            setState({
                color: colorConvert,
    ...
    return (React__default['default'].createElement("div", { ref: node, className: ['color-picker-panel', className].join(' '), tabIndex: 0 },
        React__default['default'].createElement("div", { className: 'color-picker-panel-inner' },
            React__default['default'].createElement(Board, { rootPrefixCls: 'color-picker-panel', color: state.color, colorBoardHeight: colorBoardHeight, onChange: handleChange, setChange: setChange }),
            React__default['default'].createElement("div", { className: "color-picker-panel-wrap" + (showAlpha ? ' color-picker-panel-wrap-has-alpha' : '') },
                React__default['default'].createElement("div", { className: 'color-picker-panel-wrap-ribbon' },
                    React__default['default'].createElement(Ribbon, { rootPrefixCls: 'color-picker-panel', color: state.color, onChange: handleChange, setChange: setChange })),
                showAlpha && (React__default['default'].createElement("div", { className: 'color-picker-panel-wrap-alpha' },
                    React__default['default'].createElement(Alpha, { rootPrefixCls: 'color-picker-panel', alpha: state.alpha, color: state.color, onChange: handleAlphaChange, setChange: setChange })))))));
};
...
var InputRgba = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: 'input_rgba' },
        React__default['default'].createElement("div", { className: 'input_rgba-wrap' }, inputsData(inputsProps).map(function (item, index) {
            ...
            return (React__default['default'].createElement("div", { className: wrapClass, key: index },
                labelSymbol && (React__default['default'].createElement("label", { htmlFor: 'rgba-hex', className: 'input_rgba-hex-label' }, "#")),
                name === 'alpha' && (React__default['default'].createElement("label", { htmlFor: idInput, className: 'input_rgba-alpha-label' }, "%")),
                React__default['default'].createElement("input", { type: 'text', id: idInput, value: valueInput, "aria-label": labelArea, onChange: function (e) { return onChangeInput(e); }, onBlur: onHandleSubmit, onKeyPress: function (e) { return handlePressEnter(e, onHandleSubmit); } }),
                React__default['default'].createElement("div", { className: labelClass }, labelText)));
        }))));
};

var Markers = function (_a) {
    var color = _a.color, setColor = _a.setColor, activeColor = _a.activeColor, setActiveColor = _a.setActiveColor, setInit = _a.setInit, _b = _a.format, format = _b === void 0 ? 'rgb' : _b, _c = _a.showAlpha, showAlpha = _c === void 0 ? true : _c, _d = _a.allowAddGradientStops, allowAddGradientStops = _d === void 0 ? true : _d;
    var node = React.useRef();
    var _e = __read(React.useState(false), 2), needDeleteActive = _e[0], setNeedDeleteActive = _e[1];
    var _f = __read(React.useState(false), 2), hideStop = _f[0], setHideStop = _f[1];
    var stops = color.stops, type = color.type, modifier = color.modifier;
    var onAddColorStop = function (e) {
        setInit(false);
        e.stopPropagation();
        if (!allowAddGradientStops)
            return;
        var target = e.target;
    ...
    return (React__default['default'].createElement("div", { className: 'gradient-stops', onClick: function (e) { return onAddColorStop(e); }, ref: node },
        React__default['default'].createElement("div", { className: 'gradient-stop-preview', style: {
        ...
        React__default['default'].createElement("div", { className: 'gradient-stop-marker' }, stops.map(function (color) {
            var position = color[1] * 100;
            var rgba = color[0];
            return (React__default['default'].createElement("div", { key: rgba + position + Math.random() * 100, className: "gradient-marker" + (hideStop && activeColor.index === color[2] ? ' hide' : '') + (!hideStop && activeColor.index === color[2] ? ' active' : ''), style: {
...
var checkValidColorsArray = function (arr, type) {
...
var GradientPanel = function (_a) {
    ...
    var _k = __read(React.useState(RADIALS_POS), 2), radialsPosition = _k[0], setRadialPosition = _k[1];
    ...
    return (React__default['default'].createElement("div", { className: 'gradient-interaction' },
        showGradientResult && (React__default['default'].createElement("div", { className: 'gradient-result', onMouseDown: showGradientAngle ? onMouseDown : undefined, onTouchStart: showGradientAngle ? onTouchStart : undefined, style: { background: gradient } },
            showGradientMode && (React__default['default'].createElement("div", { "data-mode": type, className: 'gradient-mode', onClick: function () { return onClickMode(); } })),
            showGradientAngle && (React__default['default'].createElement("div", { className: 'gradient-angle', ref: angleNode, style: { visibility: type === 'linear' ? 'visible' : 'hidden' } },
                React__default['default'].createElement("div", { style: {
                        transform: "rotate(" + (typeof modifier === 'number'
                            ? modifier - 90 + 'deg'
                            : modifier) + ")"
                    } }))),
            showGradientPosition && (React__default['default'].createElement("div", { className: 'gradient-pos', style: {
                    opacity: type === 'radial' ? '1' : '0',
                    visibility: type === 'radial' ? 'visible' : 'hidden'
                } }, radialsPosition.map(function (item) {
                return (React__default['default'].createElement("div", { key: item.pos, "data-pos": item.pos, className: item.active ? 'gradient-active' : '', onClick: function (e) { return setActiveRadialPosition(e); } }));
            }))))),
        showGradientStops && (React__default['default'].createElement(Markers, { color: color, setColor: setColor, activeColor: activeColor, setActiveColor: setActiveColor, setInit: setInit, format: format, showAlpha: showAlpha, allowAddGradientStops: allowAddGradientStops }))));
};
...
var GradientPanel$1 = React.memo(GradientPanel, arePropsEqual);
...
var DefaultColorPanel = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: 'default-color-panel' }, formatedDefColors.map(function (item, index) {
        switch (colorType) {
            case 'gradient':
                if (typeof item !== 'string') {
                    var gradient = item.gradient;
                    return (React__default['default'].createElement("div", { onClick: function () { return onChooseColor(item, index); }, key: item.gradient + index, className: "default-color-panel_item" + (active === index ? ' default-color-panel_item-active' : ''), style: {
                            background: gradient
                        } },
                        React__default['default'].createElement("div", { className: 'item_qub' })));
                }
                else {
                    return null;
                }
            case 'solid':
                if (typeof item === 'string') {
                    return (React__default['default'].createElement("div", { onClick: function () { return onChooseColor(item, index); }, key: item + index, className: "default-color-panel_item" + (active === index ? ' default-color-panel_item-active' : ''), style: {
                            background: item,
...
var Gradient = function (_a) {
    var _b = _a.value, value = _b === void 0 ? '#ffffff' : _b, _c = _a.onChange, onChange = _c === void 0 ? function () { return ({}); } : _c, _d = _a.format, format = _d === void 0 ? 'rgb' : _d, _e = _a.debounceMS, debounceMS = _e === void 0 ? 300 : _e, _f = _a.debounce, debounce = _f === void 0 ? true : _f, _g = _a.showAlpha, showAlpha = _g === void 0 ? true : _g, _h = _a.showInputs, showInputs = _h === void 0 ? true : _h, _j = _a.showGradientResult, showGradientResult = _j === void 0 ? true : _j, _k = _a.showGradientStops, showGradientStops = _k === void 0 ? true : _k, _l = _a.showGradientMode, showGradientMode = _l === void 0 ? true : _l, _m = _a.showGradientAngle, showGradientAngle = _m === void 0 ? true : _m, _o = _a.showGradientPosition, showGradientPosition = _o === void 0 ? true : _o, _p = _a.allowAddGradientStops, allowAddGradientStops = _p === void 0 ? true : _p, _q = _a.colorBoardHeight, colorBoardHeight = _q === void 0 ? 120 : _q, defaultColors = _a.defaultColors;
    ...
    var activeStop = rgbaToHex([lastStop[0], lastStop[1], lastStop[2]]);
    var activeIdx = stops[stops.length - 1][2];
    var _r = __read(React.useState(true), 2), init = _r[0], setInit = _r[1];
    var _s = __read(React.useState({
        hex: activeStop,
        alpha: Number(Math.round(lastStop[3] * 100)),
        loc: lastStopLoc,
        index: activeIdx
    }), 2), activeColor = _s[0], setActiveColor = _s[1];
    var _t = __read(React.useState(initColor), 2), color = _t[0], setColor = _t[1];
    ...
    var onChangeActiveColor = React.useCallback(function (value) {
        setInit(false);
    ...
    return (React__default['default'].createElement("div", { className: 'colorpicker' },
        React__default['default'].createElement(Panel, { hex: activeColor.hex, alpha: activeColor.alpha, showAlpha: showAlpha, onChange: onChangeActiveColor, colorBoardHeight: colorBoardHeight }),
        showInputs && (React__default['default'].createElement(InputRgba, { hex: activeColor.hex, alpha: activeColor.alpha, showAlpha: showAlpha, onChange: function (value) {
                return setActiveColor(function (prev) { return (__assign(__assign({}, prev), { hex: value.hex, alpha: value.alpha })); });
            }, onSubmitChange: onSubmitChange })),
        React__default['default'].createElement(GradientPanel$1, { color: color, setColor: setColor, activeColor: activeColor, setActiveColor: setActiveColor, setInit: setInit, format: format, showAlpha: showAlpha, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, allowAddGradientStops: allowAddGradientStops }),
        React__default['default'].createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setActiveColor: setActiveColor, setInit: setInit, colorType: 'gradient' })));
};

var ColorPickerSolid = function (_a) {
    var _b = _a.value, value = _b === void 0 ? '#ffffff' : _b, _c = _a.onChange, onChange = _c === void 0 ? function () { return ({}); } : _c, _d = _a.format, format = _d === void 0 ? 'rgb' : _d, _e = _a.debounceMS, debounceMS = _e === void 0 ? 300 : _e, _f = _a.debounce, debounce = _f === void 0 ? true : _f, _g = _a.showAlpha, showAlpha = _g === void 0 ? true : _g, _h = _a.showInputs, showInputs = _h === void 0 ? true : _h, _j = _a.colorBoardHeight, colorBoardHeight = _j === void 0 ? 120 : _j, defaultColors = _a.defaultColors;
    ...
    return (React__default['default'].createElement("div", { ref: node, className: 'colorpicker' },
        React__default['default'].createElement(Panel, { hex: color.hex, alpha: color.alpha, colorBoardHeight: colorBoardHeight, showAlpha: showAlpha, onChange: onCompleteChange }),
        showInputs && (React__default['default'].createElement(InputRgba, { hex: color.hex, alpha: color.alpha, format: format, showAlpha: showAlpha, onChange: setColor, onSubmitChange: onChange })),
        React__default['default'].createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setInit: setInit, colorType: 'solid' })));
};
...
var PopupTabs = function (_a) {
    ...
    var childrenContact = React__default['default'].Children.map(children, function (child) {
        return React__default['default'].cloneElement(child, {
            activeTab: activeTab
        });
    });
    return (React__default['default'].createElement("div", { className: 'popup_tabs', style: { width: popupWidth + "px" } }, childrenContact));
};
var PopupTabsHeaderLabel = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: "popup_tabs-header-label" + (activeTab === tabName ? ' popup_tabs-header-label-active' : ''), onClick: onClick }, children));
};
var PopupTabsHeader = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: 'popup_tabs-header' }, childrenContact);
};
var PopupTabsBody = function (_a) {
    ...
    return React__default['default'].createElement("div", { className: 'popup_tabs-body' }, childrenContact);
};
var PopupTabsBodyItem = function (_a) {
    var children = _a.children, activeTab = _a.activeTab, tabName = _a.tabName;
    if (activeTab === tabName) {
        return React__default['default'].createElement("div", { className: 'popup_tabs-body-item' }, children);
    }
    return null;
};
...
var ColorPicker = function (_a) {
    ...
    if (solid && gradient) {
        return (React__default['default'].createElement(PopupTabs, { activeTab: activeTab, popupWidth: popupWidth },
            ...
            React__default['default'].createElement(PopupTabsBody, null,
                React__default['default'].createElement(PopupTabsBodyItem, { tabName: 'solid' },
                    React__default['default'].createElement(ColorPickerSolid, { onChange: onChangeSolid, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, colorBoardHeight: colorBoardHeight })),
                React__default['default'].createElement(PopupTabsBodyItem, { tabName: 'gradient' },
                    React__default['default'].createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, allowAddGradientStops: allowAddGradientStops, colorBoardHeight: colorBoardHeight })))));
    }
    return (React__default['default'].createElement(React__default['default'].Fragment, null, solid || gradient ? (React__default['default'].createElement(PopupTabs, { popupWidth: popupWidth },
        React__default['default'].createElement(PopupTabsBody, null,
            solid ? (React__default['default'].createElement(ColorPickerSolid, { onChange: onChangeSolid, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, colorBoardHeight: colorBoardHeight })) : (React__default['default'].createElement(React.Fragment, null)),
            gradient ? (React__default['default'].createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, allowAddGradientStops: allowAddGradientStops, colorBoardHeight: colorBoardHeight })) : (React__default['default'].createElement(React.Fragment, null))))) : null));
};
