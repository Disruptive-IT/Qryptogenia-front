...
var Markers = function (_a) {
    ...
    var node = useRef();
    var _e = __read(useState(false), 2), needDeleteActive = _e[0], setNeedDeleteActive = _e[1];
    var _f = __read(useState(false), 2), hideStop = _f[0], setHideStop = _f[1];
...
var GradientPanel = function (_a) {
    ...
    var _k = __read(useState(RADIALS_POS), 2), radialsPosition = _k[0], setRadialPosition = _k[1];
    ...
    return (React.createElement("div", { className: 'gradient-interaction' },
        ...
        showGradientStops && (React.createElement(Markers, { color: color, setColor: setColor, activeColor: activeColor, setActiveColor: setActiveColor, setInit: setInit, format: format, showAlpha: showAlpha, allowAddGradientStops: allowAddGradientStops }))));
};
...
var Gradient = function (_a) {
    ...
    var activeStop = rgbaToHex([lastStop[0], lastStop[1], lastStop[2]]);
    var activeIdx = stops[stops.length - 1][2];
    var _r = __read(useState(true), 2), init = _r[0], setInit = _r[1];
    var _s = __read(useState({
        hex: activeStop,
        alpha: Number(Math.round(lastStop[3] * 100)),
        loc: lastStopLoc,
        index: activeIdx
    }), 2), activeColor = _s[0], setActiveColor = _s[1];
    var _t = __read(useState(initColor), 2), color = _t[0], setColor = _t[1];
    ...
    return (React.createElement("div", { className: 'colorpicker' },
        ...
        React.createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setActiveColor: setActiveColor, setInit: setInit, colorType: 'gradient' })));
};
...
var ColorPickerSolid = function (_a) {
    ...
    return (React.createElement("div", { ref: node, className: 'colorpicker' },
        ...
        React.createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setInit: setInit, colorType: 'solid' })));
};
...
var ColorPicker = function (_a) {
        ...
        return (React.createElement(PopupTabs, { activeTab: activeTab, popupWidth: popupWidth },
            ...
            React.createElement(PopupTabsBody, null,
                React.createElement(PopupTabsBodyItem, { tabName: 'solid' },
                    React.createElement(ColorPickerSolid, { onChange: onChangeSolid, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, colorBoardHeight: colorBoardHeight })),
                React.createElement(PopupTabsBodyItem, { tabName: 'gradient' },
                    React.createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, allowAddGradientStops: allowAddGradientStops, colorBoardHeight: colorBoardHeight })))));
    }
    return (React.createElement(React.Fragment, null, solid || gradient ? (React.createElement(PopupTabs, { popupWidth: popupWidth },
        React.createElement(PopupTabsBody, null,
            ...
            gradient ? (React.createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, allowAddGradientStops: allowAddGradientStops, colorBoardHeight: colorBoardHeight })) : (React.createElement(Fragment, null))))) : null));
};
