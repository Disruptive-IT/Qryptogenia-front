...
export const WebLinkPhoneMusic = ({ musicFormValues }) => {
  ...
  return (
    <div className='relative flex flex-col h-full items-center rounded-t-[52px] rounded-b-[50px] w-full p-5 overflow-y-auto custom-scrollbarphone' style={{ background: musicFormValues.backgroundColor, minHeight: '670px', maxHeight: '670px', minWidth: '350px', maxWidth: '350px' }}>
