 ...
 * @date : 2024-09-04
 * @description : El componente `DetailModal` muestra un modal que presenta detalles de un código QR. Incluye una vista previa de la imagen del QR, el nombre del QR, 
 * el tipo de QR, el estado (activo/inactivo) y la fecha de creación. Utiliza `react-i18next` para la traducción de textos. El modal se cierra al hacer clic fuera 
 * del área del modal o al hacer clic en el botón de cerrar.
 * @Props : 
