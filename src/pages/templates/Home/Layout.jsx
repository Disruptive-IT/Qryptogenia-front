...
function LayoutHome() {
    ...
    return (
        <div className="flex flex-col h-sreen  w-full bg-slate-200 ">
            ...
            {location.pathname !== '/login' && location.pathname !== '/register' && location.pathname !== '/aboutUs' && location.pathname !== '/faq'  && location.pathname !== '/forgotPassword' && location.pathname !== '/pricings' && location.pathname !== '/recoverPassword' && (
                <div className='mt-10'>
                    <StepperQr />
                </div>
            )}
